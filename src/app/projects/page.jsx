...
const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/BiruktiShife/Jobs-Board",
    description:
      "A comprehensive finance management platform with real-time analytics and budget tracking.A web-based job board system that allows companies to post job listings and job seekers to browse, search, and apply for jobs.",
    features: [
      "User authentication (Job Seeker / Recruiter roles)",
      "Job posting and management dashboard",
      "Job search and filtering system",
      "Application submission system",
      "Admin control for managing listings",
    ],
  },
  {
  ...
  },
  {
    ...
    github: "https://github.com/BiruktiShife/Tatari",
    description:
      "Ethiopian skills marketplace connecting clients with service providers.",
    features: [
      "Client features: Post jobs, receive quotes",
      "message providers, track job lifecycle",
      "Provider features: Browse jobs, submit quotes",
      "Admin features: Analytics dashboard, user management",
    ],
  },
];
